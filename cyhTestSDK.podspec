#
#  Be sure to run `pod spec lint cyhTestSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/714627034/podSubmodule.git", :tag => "2.1", :submodules => true }
